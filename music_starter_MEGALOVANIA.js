...
/////////////////Parameters////////////////////////
 ...
 ////////////////Functions////////////////////////
   ...
   function Bones(){
      for (i=0; i< 7; i++){
      let lengthSpeed = 0.6+(0.02*drum);
   
      if (frameCount < 950) { 
        boneX = (100-i*100) + frameCount;
      }
      else {
        boneX = (-40-i*100) + frameCount*3;
      }
      ...
      if(boneX > 1 && boneX < 320) {
         ...
         bone_length = map(bass,0,100,(200+(65*(lengthSpeed*10)))-(boneX*lengthSpeed),300+(65*(lengthSpeed*10))-(boneX*lengthSpeed));
      }
      else{
